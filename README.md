...
1. **Take or upload a screenshot** of your desktop or application window.
2. The tool will identify parts such as buttons, text boxes, or other UI elements.
3. Use the **Find** function to target an element you want to interact with.
4. Use **Wait** if you want the tool to pause until this element appears.
5. Use **Click** to simulate a mouse click on that element.
6. Use **Type** to add text, if needed.
7. Use **Coordinate Calibration** if elements shift around on your screen.
...
- If the app does not open, try right-clicking the `.exe` file and select "Run as administrator."
- Disable antivirus temporarily during installation if it blocks the process.
